...
namespace xnano.UWP.Gamestream
{
        ...
        : MediaCodec.Callback, IDisposable
    {
        ...
        bool SetCodecSpecificData(byte[] sps, byte[] pps)
        {
            ...
            _mediaFormat.SetByteBuffer("csd-0", /*Java.Nio.ByteBuffer.Wrap(sps)*/default);
            _mediaFormat.SetByteBuffer("csd-1", /*Java.Nio.ByteBuffer.Wrap(pps)*/default);
            return true;
        }
        ...
        public bool Initialize()
        {
            ...
            {
                _mediaFormat.SetInteger(MediaFormat.KeyOperatingRate, /*Short.MaxValue*/Int32.MaxValue);
            }
        ...
        public override void OnInputBufferAvailable(MediaCodec codec, int index)
        {
            ...
            if (data != null)
            {
                ...
                buffer.Put(data,default,default);
        ...
        public override void OnOutputBufferAvailable(MediaCodec codec, int index, MediaCodec.BufferInfo info)
        {
            ...
            /*Java.Nio.ByteBuffer*/ var decodedSample = codec.GetOutputBuffer(index);
